...
const NAV_ICONS: Record<Page, (active:boolean)=>React.ReactNode> = {
  ...
  lab:      (a) => <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={a?'#2BFFF1':'#374151'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2v7.31"/><path d="M14 9.3V1.99"/><path d="M8.5 2h7"/><path d="M14 9.3a6.5 6.5 0 11-8 0"/></svg>,
      ...
      <div className="border-b border-white/[0.06] bg-[#05060B]/90 backdrop-blur-sm sticky top-0 z-50 flex-shrink-0">
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            <LiveMockToggle/>
            <button onClick={()=>setShowTransfer(true)} className="p-1.5 rounded-xl border border-white/[0.07] text-[#4B5563] hover:text-[#2BFFF1] hover:border-[#2BFFF1]/30 transition-all" title="Transfer funds">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polyline points="7 16 3 12 7 8"/><polyline points="17 8 21 12 17 16"/><line x1="3" y1="12" x2="21" y2="12"/></svg>
            </button>
